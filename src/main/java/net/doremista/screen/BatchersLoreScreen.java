...
public class BatchersLoreScreen extends Screen {
    private static final Identifier TEXTURE = new Identifier("doremitales", "textures/gui/batcherslore.png");

    public BatchersLoreScreen() {
